...
public abstract class PasscodeView extends View {
    ...
    private boolean mIsTactileFeedbackEnabled = false;       //Bool to indicate weather to enable tactile feedback
    ...
    public abstract void setCorrectPasscode(int[][] passcode);

    public abstract int[][] getTypedPasscode();
